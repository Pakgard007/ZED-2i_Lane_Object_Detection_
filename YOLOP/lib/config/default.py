...
_C.LOSS.DA_SEG_GAIN = 0.5  # driving area segmentation loss gain
_C.LOSS.LL_SEG_GAIN = 0.5  # lane line segmentation loss gain
_C.LOSS.LL_IOU_GAIN = 0.2 # lane line iou loss gain


# DATASET related params
_C.DATASET = CN(new_allowed=True)
_C.DATASET.DATAROOT = '/home/satoi/BddDataset/images'       # the path of images folder
_C.DATASET.LABELROOT = '/home/satoi/BddDataset/det'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/home/satoi/BddDataset/drivable'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/home/satoi/BddDataset/lane'               # the path of ll_seg_annotations folder

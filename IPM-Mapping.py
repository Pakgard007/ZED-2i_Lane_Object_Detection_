...
input_video_path =  '/home/mag/satoi/final.mp4' 
output_video_path = '/home/mag/satoi/python/result' 
...
def IPM(image):
    ...
    destination_points = np.float32([
        [150, 0],                   # Top-left corner
        [width - 150, 0],               # Top-right corner
...
def picture_in_picture(main_image, overlay_image, img_ratio=3, border_size=5, x_margin=30, y_offset_adjust=-100):
    """
